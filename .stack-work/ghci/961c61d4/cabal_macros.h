...
/* package paredao-0.1.0.0 */
#ifndef VERSION_paredao
#define VERSION_paredao "0.1.0.0"
#endif /* VERSION_paredao */
#ifndef MIN_VERSION_paredao
#define MIN_VERSION_paredao(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_paredao */
...
/* package gloss-1.13.1.2 */
#ifndef VERSION_gloss
#define VERSION_gloss "1.13.1.2"
#endif /* VERSION_gloss */
...
#define CURRENT_COMPONENT_ID "paredao-0.1.0.0-GatuTnyxiMH4lGbcEvtQlF-paredao"
